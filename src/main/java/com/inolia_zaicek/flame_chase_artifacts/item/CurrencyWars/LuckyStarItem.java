...
public class LuckyStarItem extends CuriosTootip1Item {
    //ForgeMod.BLOCK_REACH.get()
    @Override
    public Multimap<Attribute, AttributeModifier> getAttributeModifiers(SlotContext slotContext, UUID uuid, ItemStack stack) {
        Multimap<Attribute, AttributeModifier> atts = LinkedHashMultimap.create();
        atts.put(FCAAttributes.LUCK_HIT_CHANCE.get(), new AttributeModifier(uuid, this.getTooltipItemName(), 0.05, AttributeModifier.Operation.ADDITION));
        return atts;
    }
    @Override
